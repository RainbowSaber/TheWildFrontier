...
execute as @e[type=piglin,predicate=starmute:toxic_heap] run effect give @s poison 10 1
...
execute as @a at @s[predicate=starmute:in_structure] if entity @e[type=armor_stand,distance=..120,tag=castle_detector] run advancement grant @s only starmute:incendium/enter_castle
execute as @a at @s[predicate=starmute:in_structure] if entity @e[type=armor_stand,distance=..120,tag=castle_detector] unless entity @e[type=piglin_brute,tag=castle,distance=..160] run advancement grant @s only starmute:incendium/conquer_castle
...
execute as @e[type=item,nbt={Item:{id:"minecraft:glowstone_dust",Count:1b,tag:{glow:1b}}}] at @s run function starmute:artifact/glow_powder
...
execute as @e[type=arrow,tag=cluster,nbt={inGround:1b}] at @s run function starmute:artifact/patron/cluster/explode
