...
execute at @s run summon minecraft:firework_rocket ~ ~1 ~ {Silent:1b,Motion:[0.0,0.0,0.0],ShotAtAngle:1,LifeTime:0,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Flight:1,Explosions:[{Type:4,Flicker:0,Trail:0,Colors:[I;65535]},{Type:4,Flicker:0,Trail:0,Colors:[I;65535]},{Type:4,Flicker:0,Trail:0,Colors:[I;65535]},{Type:4,Flicker:0,Trail:0,Colors:[I;65535]},{Type:4,Flicker:0,Trail:0,Colors:[I;65535]},{Type:4,Flicker:0,Trail:0,Colors:[I;65535]}]}}}}
...
execute at @s positioned ~ ~1 ~ if score #hit in.fire_laser matches 0 if predicate starmute:87_percent if score #distance2 in.fire_laser matches 0..3000 positioned ^ ^ ^0.2 facing entity @e[type=#starmute:mobs,tag=!laser,distance=..10,sort=nearest,limit=1] eyes if block ~ ~ ~ #starmute:airs run function starmute:weapon_2/branch_straight
