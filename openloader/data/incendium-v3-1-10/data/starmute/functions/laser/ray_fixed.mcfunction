...
execute if predicate starmute:20_percent run particle minecraft:dust 1 0.3 0.7 1.65 ~ ~ ~ 0.01 0.01 0.01 0.0 1 force
execute if score #hit in.fire_laser matches 0 if score #distance in.fire_laser matches ..120 positioned ^ ^ ^0.3 run function starmute:laser/ray_fixed
