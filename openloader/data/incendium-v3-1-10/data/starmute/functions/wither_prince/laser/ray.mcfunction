...
execute if score #hit in.fire_laser matches 0 if score #distance in.fire_laser matches ..250 positioned ^ ^ ^0.2 rotated ~ ~ run function starmute:wither_prince/laser/ray