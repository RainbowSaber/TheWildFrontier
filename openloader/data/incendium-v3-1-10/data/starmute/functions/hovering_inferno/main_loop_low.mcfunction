...
execute as @e[type=blaze,tag=inferno] at @s if score %inferno in.inf_health matches ..350 if predicate starmute:40_percent run function starmute:hovering_inferno/spell_cards/dash
...
execute as @e[type=blaze,tag=inferno] at @s if predicate starmute:30_percent run function starmute:hovering_inferno/spell_cards/direct_attack
execute as @e[type=blaze,tag=inferno] at @s if predicate starmute:30_percent run function starmute:hovering_inferno/spell_cards/direct_attack_alternate
execute if score %inferno in.spell_card matches ..1 as @e[type=blaze,tag=inferno] at @s if predicate starmute:20_percent run function starmute:hovering_inferno/spell_cards/firework_attack
#execute if score %inferno in.spell_card matches ..1 as @e[type=blaze,tag=inferno] at @s if predicate starmute:20_percent run function starmute:hovering_inferno/spell_cards/shulker_attack
execute if score %inferno in.spell_card matches ..1 as @e[type=blaze,tag=inferno] at @s if predicate starmute:20_percent run function starmute:hovering_inferno/spell_cards/shulker_attack_curved
execute if score %inferno in.spell_card matches ..2 as @e[type=blaze,tag=inferno] at @s if predicate starmute:20_percent run function starmute:hovering_inferno/spell_cards/shield_lasers_random
...
execute if score %inferno in.spell_card matches ..1 as @e[type=blaze,tag=inferno] at @s if predicate starmute:40_percent run function starmute:hovering_inferno/spell_cards/summon_vex
execute if score %inferno in.spell_card matches ..1 as @e[type=blaze,tag=inferno] at @s if predicate starmute:98_percent run function starmute:hovering_inferno/spell_cards/fireball
...
execute as @e[type=blaze,tag=inferno] at @s run function starmute:sub_spell/kill_bullets
...
execute as @e[type=blaze,tag=inferno] at @s if score %inferno in.inf_health matches ..200 run schedule function starmute:hovering_inferno/main_loop_low 320t
