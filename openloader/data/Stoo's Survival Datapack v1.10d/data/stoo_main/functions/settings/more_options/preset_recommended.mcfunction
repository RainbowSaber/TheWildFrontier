...
function helth:settings/enable_legacy
function animoles:settings/naming_disable

function hardness:settings/change_to_survival
...
tellraw @s ["",{"text":"Successfully changed options to recommended preset.","color":"#4d7288"}]