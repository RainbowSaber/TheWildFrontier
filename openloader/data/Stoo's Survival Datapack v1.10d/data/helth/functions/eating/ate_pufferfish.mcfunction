...
advancement revoke @s only helth:eating/pufferfish_adv

# Food and Health points given:
#	+4 Food
execute if score experimentalRegenEnabled StooSettings matches 1 run effect give @s poison 24 1 true
scoreboard players add @s StooFood 4
