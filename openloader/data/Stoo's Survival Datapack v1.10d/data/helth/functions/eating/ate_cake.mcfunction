...
advancement revoke @s only helth:eating/cake_adv

# Food and Health points given:
#	+8 Food (40 in total)
#	+1.5 Hearts (7.5 in total)
effect give @s regeneration 2 2 true
execute if score experimentalRegenEnabled StooSettings matches 1 run scoreboard players add @s StooFood 8
