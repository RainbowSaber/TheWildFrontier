...
advancement revoke @s only helth:eating/cookie_adv
...
execute if score experimentalRegenEnabled StooSettings matches 1 run scoreboard players add @s StooFood 3
