recipe take @s helth:stoo/glistering_melon

advancement revoke @s only helth:stoo/glistering_melon_adv
advancement grant @s only helth:husbandry/glistering_stew

give @s[scores={StooStewCrafted=1..}] minecraft:suspicious_stew{Effects:[{EffectId:6,EffectDuration:1}], CustomModelData:505, display:{Name:"{\"text\":\"§r§eGlistering Mushroom Stew\"}"}} 1
