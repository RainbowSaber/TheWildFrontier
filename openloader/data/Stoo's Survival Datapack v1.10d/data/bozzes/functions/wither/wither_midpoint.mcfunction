...
# EFFECTS
execute at @s run playsound minecraft:ambient.basalt_deltas.mood hostile @a[distance=..100]
execute at @s run playsound minecraft:ambient.nether_wastes.additions ambient @a[distance=..100]
