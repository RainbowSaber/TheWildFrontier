execute at @s run setblock ~ ~ ~ minecraft:structure_block{mode:"LOAD",posX:-5,posY:-10,posZ:-5,name:"custom:hivenest"}
...
execute at @s run fill ~-5 1 ~-5 ~5 1 ~5 minecraft:yellow_wool
